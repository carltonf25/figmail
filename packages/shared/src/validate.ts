import { EmailAst, Section, Column, Block, TextBlock, ImageBlock, ButtonBlock, DividerBlock, SpacerBlock } from "./ast.js";
 ...
 */
export function validateEmailAst(ast: EmailAst): ValidationResult {
...
function validateSection(section: Section, path: string, errors: ValidationError[], warnings: ValidationError[]): void {
...
function validateColumn(column: Column, path: string, errors: ValidationError[], warnings: ValidationError[]): void {
...
function validateBlock(block: Block, path: string, errors: ValidationError[], warnings: ValidationError[]): void {
  switch (block.type) {
    case "text":
      validateTextBlock(block as TextBlock, path, errors, warnings);
      break;
    case "image":
      validateImageBlock(block as ImageBlock, path, errors, warnings);
      break;
    case "button":
      validateButtonBlock(block as ButtonBlock, path, errors, warnings);
      break;
    case "divider":
      validateDividerBlock(block as DividerBlock, path, errors, warnings);
      break;
    case "spacer":
      validateSpacerBlock(block as SpacerBlock, path, errors, warnings);
      break;
  }
}

function validateTextBlock(block: TextBlock, path: string, errors: ValidationError[], warnings: ValidationError[]): void {
...
function validateImageBlock(block: ImageBlock, path: string, errors: ValidationError[], warnings: ValidationError[]): void {
...
function validateButtonBlock(block: ButtonBlock, path: string, errors: ValidationError[], warnings: ValidationError[]): void {
...
function validateDividerBlock(block: DividerBlock, path: string, errors: ValidationError[], warnings: ValidationError[]): void {
...
function validateSpacerBlock(block: SpacerBlock, path: string, errors: ValidationError[], warnings: ValidationError[]): void {
  if (block.height > 100) {
    warnings.push({
 ...
 */
export function validateEmailAstQuick(ast: EmailAst): boolean {
  try {
 ...
 */
export function getValidationErrors(ast: EmailAst): string[] {
  const result = validateEmailAst(ast);
 ...
 */
export function getValidationWarnings(ast: EmailAst): string[] {
  const result = validateEmailAst(ast);
